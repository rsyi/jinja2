...
//!
//! jinja2rust fills the gaps between minijinja and the full Jinja2 spec by:
...
//!
//! ```rust
//! use jinja2rust::{Environment, context};
//!
...
/// - The `callable` test
///
/// This is the recommended entry point for jinja2rust.
